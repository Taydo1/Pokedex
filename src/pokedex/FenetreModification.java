...
public class FenetreModification extends JPanel {
  ...
  private void initComponent(){
    ...
    nomen.setText(list.get(0).en_name);
    ...
    talent1.setSelectedItem(listTalent.get(list.get(0).id_ability1));
    ...
    if (list.get(0).id_ability2 != 0){
        talent2.setSelectedItem(listTalent.get(list.get(0).id_ability2));
    } else {
    ...
    if (list.get(0).id_ability3 != 0){
        talent3.setSelectedItem(listTalent.get(list.get(0).id_ability3));
    } else {
    ...
    if (list.get(0).id_ability4 != 0){
        talent4.setSelectedItem(listTalent.get(list.get(0).id_ability4));
    } else {
    ...
    type1.setSelectedItem(types.get(list.get(0).id_type1));
    ...
    if (list.get(0).id_type2 != 0){
        type2.setSelectedItem(types.get(list.get(0).id_type2));
    } else {
    ...
    generation.setSelectedItem(gen[list.get(0).generation - 1]);
    ...
    taille.setValue(list.get(0).height);
    ...
    poids.setValue(list.get(0).weight);
    ...
    pourcentage.setValue(list.get(0).weight);
